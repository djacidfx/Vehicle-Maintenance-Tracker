...
public class Currency {
    ...
    private static void sort(List<CurrencyModel> list) {
        Collections.sort(list, new Comparator<CurrencyModel>() { 
            @Override 
            public int compare(CurrencyModel text1, CurrencyModel text2) {
                return text1.getCurrencyName().compareToIgnoreCase(text2.getCurrencyName());
            }
        });
    }
}
