...
public class TotalMonthStatisticAdapter extends RecyclerView.Adapter<TotalMonthStatisticAdapter.ViewHolder> {
    ArrayList<Integer> colors;
    Context context;
    List<MonthlyReportModel> reportDataModelList;

    public TotalMonthStatisticAdapter(Context context, List<MonthlyReportModel> reportDataModelList, ArrayList<Integer> colors) {
